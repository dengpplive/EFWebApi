...
namespace QConnectSDK.Api
{
    public partial class RestApi
    {
        ...
        /// <returns></returns>
        public void AddWeiboAsync(Action<AddWeiboResult> success, Action<QzoneException> failure, string content, string clientip = "", string jing = "", string wei = "", int syncflag = 0)
        {
        ...
        /// <param name="syncflag">标识是否将发布的微博同步到QQ空间（0：同步； 1：不同步；），默认为0.</param>
        /// <returns></returns>
        public void AddWeiboPictureAsync(Action<AddWeiboResult> success, Action<QzoneException> failure, string content, string fileName, byte[] picBytes, string clientip = "", string jing = "", string wei = "", int syncflag = 0)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        /// <returns></returns>
        public void DelWeiboAsync(Action<DelWeiboResult> success, Action<QzoneException> failure, Int64 id)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        /// </param>
        public void GetRepostlistAsync(Action<WeiboRePost> success, Action<QzoneException> failure, string flag, string rootid, string pageflag, string pagetime, string reqnum, string twitterid)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        /// </summary>
        /// <returns></returns>
        public void GetWeiboUserInfoAsync(Action<WeiboUser> success, Action<QzoneException> failure)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        /// <returns></returns>
        public void GetOtherWeiboUserInfoAsync(Action<WeiboUser> success, Action<QzoneException> failure,string name, string openId)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        public void GetFansListAsync(Action<WeiboFan> success, Action<QzoneException> failure, int reqnum, int startindex)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        public void GetIdolListAsync(Action<WeiboIdol> success, Action<QzoneException> failure, int reqnum, int startindex)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        /// <returns></returns>
        public void AddIdolAsync(Action<MicroBlogBase> success, Action<QzoneException> failure, string name, string fopenids)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
        ...
        /// <returns></returns>
        public void DelIdolAsync(Action<MicroBlogBase> success, Action<QzoneException> failure, string name, string fopenid)
        {
            _restClient.Authenticator = new OAuthUriQueryParameterAuthenticator(context.AccessToken.OpenId, context.AccessToken.AccessToken, context.Config.GetAppKey());
