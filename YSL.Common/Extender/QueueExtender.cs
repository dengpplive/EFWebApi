...
/*用法:
  var _queueExt = new QueueExt<T>(100);
  //注册事件 添加Enqueue时会触发
  _queueExt.OnQueueEventHandler += (s, e) => {
    //操作...
  };
*/
namespace YSL.Common.Extender
{
    ...
    public class QueueExtender<T> : IDisposable
    {
        /// <summary>
        /// 信号开关
        /// </summary>
        ...
        public QueueExtender(int maxCount = 5, bool isStartThreadListener = true)
        {
