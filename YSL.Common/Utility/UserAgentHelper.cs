    ...
    public class UserAgentHelper
    {
        ...
        public static int GetDeviceType()
        {
            if (HttpContext.Current != null || HttpContext.Current.Request != null)
            {
                ...
                UserAgent userAgent = UserAgentHelper.GetUserAgent(HttpContext.Current.Request.UserAgent);
                if (userAgent != null)
                {
                    if (userAgent.PlatformType == "Android") return 2;
                    if (userAgent.PlatformType == "iPhone" || userAgent.PlatformType == "iPad" || userAgent.PlatformType == "Mac") return 3;
                }
            }
   ...
   */
    ...
    */
        public static UserAgent GetUserAgent(String userAgent)
        {
            ...
            try
            {
                String platformSeries = String.Empty, platformVersion = String.Empty;
                ...
                else if (userAgent.Contains("Mac OS X"))
                {
                    ...
                    if (userAgent.Contains("Macintosh"))
                    {
                        ...
                        {
                            String temp = userAgent.Substring(userAgent.IndexOf("Intel Mac OS X"));
                            if (temp.IndexOf(")") > -1)
                            {
                                platformSeries = temp.Substring(14, temp.IndexOf(")") - 14);
                            }
                        }
                        return JudgeBrowser(userAgent, "Mac", platformSeries, platformVersion);//判断浏览器  
                    }
                    else if (userAgent.Contains("iPhone"))
                    {
                        if (userAgent.Contains("CPU iPhone OS"))
                        {
                            String temp = userAgent.Substring(userAgent.IndexOf("CPU iPhone OS"));
                            if (temp.IndexOf("like Mac OS X") > -1)
                            {
                                platformSeries = temp.Substring(14, temp.IndexOf("like Mac OS X") - 14);
                            }
                        }
                        return JudgeBrowser(userAgent, "iPhone", platformSeries, platformVersion);//判断浏览器  
                    }
                    else if (userAgent.Contains("iPad"))
                    {
                        if (userAgent.Contains("CPU OS"))
                        {
                            String temp = userAgent.Substring(userAgent.IndexOf("CPU OS"));
                            if (temp.IndexOf("like Mac OS X") > -1)
                            {
                                platformSeries = temp.Substring(6, temp.IndexOf("like Mac OS X") - 6);
                            }
                        }
                        return JudgeBrowser(userAgent, "iPad", platformSeries, platformVersion);//判断浏览器  
                    }
                }
              ...
              * 判断依据:http://www.gtrifonov.com/2011/04/15/google-android-user-agent-strings-2/
                     * https://developers.google.com/chrome/mobile/docs/user-agent
              */
                    if (userAgent.Contains(" Android "))
                    {
                        String temp = userAgent.Substring(userAgent.IndexOf(" Android "));
                        if (temp.IndexOf(";") > -1)
                        {
                            ...
                            {
                                platformSeries = tmpArray[0];
                                platformVersion = tmpArray[1];
                            }
                            else
                            {
                                platformSeries = tmpArray[0];
                    ...
                    return JudgeBrowser(userAgent, "Android", platformSeries, platformVersion);//判断浏览器  
                }
                else if (userAgent.Contains("Adr"))
                {
                    /** 
              * *********** 
              * Android 系列 
              ...
              */
                    ...
                    {
                        String temp = userAgent.Substring(userAgent.IndexOf(" Adr "));
                        if (temp.IndexOf(";") > -1)
                        {
                            temp = temp.Substring(5, temp.IndexOf(";") - 5);
                            String[] tmpArray = temp.Split('-');
                            if (tmpArray.Length == 2)
                            {
                                platformSeries = tmpArray[0];
                ...
                if (bc != null)
                {
                    ...
                    _userAgent.BrowserType = bc.Browser;
                    _userAgent.BrowserVersion = bc.Version;
                    _userAgent.PlatformSeries = string.Empty;
                    _userAgent.PlatformType = bc.Platform;
                    _userAgent.PlatformVersion = string.Empty;
                    return _userAgent;
                }
            }
            catch (Exception ex)
    ...
    */
        private static UserAgent JudgeBrowser(String userAgent, String platformType, String platformSeries, String platformVersion)
        {
            ...
            else if (userAgent.Contains("MSIE") || userAgent.Contains("rv"))
            {
                /** 
                 * ******* 
                 * IE 系列 
            ...
            else if (userAgent.Contains("Mac OS X"))
            {
                ...
                if (userAgent.Contains("Version/"))
                {
                    ...
                    //拿到User Agent String "Version/" 之后的字符串,结果形如"Version/6.0 Mobile/10B142 Safari/8536.25  
                }
                String safariVersion = null;
                if (temp.IndexOf(" ") < 0)
                {//temp形如"24.0.1295.0"  
                    safariVersion = temp;
                }
                ...
                {//temp形如"24.0.1295.0 Safari/537.15"  
                    safariVersion = temp.Substring(0, temp.IndexOf(" "));
                }
                return new UserAgent("Safari", safariVersion, platformType, platformSeries, platformVersion);
            }
            string browserType = string.Empty, browserVersion = string.Empty;
            HttpBrowserCapabilities bc = HttpContext.Current.Request.Browser;
            if (bc != null)
            {
                browserType = bc.Browser;
                browserVersion = bc.Version;
            }
            return new UserAgent(browserType, browserVersion, platformType, platformSeries, platformVersion);
