...
using System.Text;
using YSL.Common.Resources.resx;
...
namespace YSL.Common.Utility
{
    ...
    public static class DateHelper
    {
        ...
        public static string GetDateString(DateFormat xDateFormat)
        {
            ...
            switch (xDateFormat)
            {
                case DateFormat.ddMMyyyys:
                    myDateString = Date.ddMMyyyys;
                    break;
                case DateFormat.ddMMyyyyn:
                    myDateString = Date.ddMMyyyyn;
                    break;
                case DateFormat.ddMMyyyysp:
                    myDateString = Date.ddMMyyyysp;
                    break;
                case DateFormat.ddMMyyyyd:
                    myDateString = Date.ddMMyyyyd;
                    break;
                case DateFormat.ddMMMyyyys:
                    myDateString = Date.ddMMMyyyys;
                    break;
                case DateFormat.ddMMMyyyyn:
                    myDateString = Date.ddMMMyyyyn;
                    break;
                case DateFormat.ddMMMyyyysp:
                    myDateString = Date.ddMMMyyyysp;
                    break;
                case DateFormat.ddMMMyyyyd:
                    myDateString = Date.ddMMMyyyyd;
                    break;
                case DateFormat.MMMddyyyyspcm:
                    myDateString = Date.MMMddyyyyspcm;
                    break;
                case DateFormat.ddMMMyyyyspwt:
                    myDateString = Date.ddMMMyyyyspwt;
                    break;
                case DateFormat.ddMMMyyyyHHmm:
                    myDateString = Date.ddMMMyyyyHHmm;
                    break;
                case DateFormat.yyyyMMMdd:
                    myDateString = Date.yyyyMMMdd;
                    break;
                case DateFormat.yyyyMMdd:
                    myDateString = Date.yyyyMMdd;
                    break;
                case DateFormat.yyyyMMddd:
                    myDateString = Date.yyyyMMddd;
                    break;
                case DateFormat.yyMMddHHmm:
                    myDateString = Date.yyMMddHHmm;
                    break;
                case DateFormat.MMMdd:
                    myDateString = Date.MMMdd;
                    break;
                case DateFormat.ddMMMyyyyddd:
                    myDateString = Date.ddMMMyyyyddd;
                    break;
                case DateFormat.ddMMMyyyyml:
                    myDateString = Date.ddMMMyyyyml.ToString();
                    break;
                case DateFormat.ddMMMml:
                    myDateString = Date.ddMMMml.ToString();
                    break;
                case DateFormat.ddMMMspwt:
                    myDateString = Date.ddMMMspwt;
                    break;
                ...
                case DateFormat.ddMMMyyyy:
                    myDateString = Date.ddMMMyyyy;
                    break;
                case DateFormat.MMMyyyy:
                    myDateString = Date.MMMyyyy;
                    break;
                case DateFormat.dd_space_MMM_comma_yyyy:
                    myDateString = Date.dd_space_MMM_comma_yyyy;
                    break;
                case DateFormat.ddMMMyy:
                    myDateString = Date.ddMMMyy;
                    break;
                case DateFormat.MMMddyyyyHHmm:
                    myDateString = Date.MMMddyyyyHHmm;
                    break;
                default:
                    myDateString = Date.ResourceManager.GetString(xDateFormat.ToString());
                    break;
            }
            return myDateString;
        }
        ...
        public static string GetMonthString(byte month)
        {
            ...
            {
                case 1:
                    monthString = Date.Jan;
                    break;
                case 2:
                    monthString = Date.Feb;
                    break;
                case 3:
                    monthString = Date.Mar;
                    break;
                case 4:
                    monthString = Date.Apr;
                    break;
                case 5:
                    monthString = Date.May;
                    break;
                case 6:
                    monthString = Date.Jun;
                    break;
                case 7:
                    monthString = Date.Jul;
                    break;
                case 8:
                    monthString = Date.Aug;
                    break;
                case 9:
                    monthString = Date.Sep;
                    break;
                case 10:
                    monthString = Date.Oct;
                    break;
                case 11:
                    monthString = Date.Nov;
                    break;
                case 12:
                    monthString = Date.Dec;
                    break;
            }
            return monthString;
        }
        ...
        public static string GetWeekdayString(DateTime weekday)
        {
            ...
            {
                case 1:
                    weekString = Date.Monday;
                    break;
                case 2:
                    weekString = Date.Tuesday;
                    break;
                case 3:
                    weekString = Date.Webnesday;
                    break;
                case 4:
                    weekString = Date.Thursday;
                    break;
                case 5:
                    weekString = Date.Friday;
                    break;
                case 6:
                    weekString = Date.Saturday;
                    break;
                case 7:
                    weekString = Date.Sunday;
                    break;
            }
            return weekString;
        }
        ...
        public static string GetWeekdayStringNumFormat(DateTime weekday)
        {
            int i = GetDateTimeWeekDay(weekday);
            string weekString = "";
            switch (i)
            {
                case 1:
                    weekString = Date.MonNum;
                    break;
                case 2:
                    weekString = Date.TueNum;
                    break;
                case 3:
                    weekString = Date.WebNum;
                    break;
                case 4:
                    weekString = Date.ThuNum;
                    break;
                case 5:
                    weekString = Date.FriNum;
                    break;
                case 6:
                    weekString = Date.SatNum;
                    break;
                case 7:
                    weekString = Date.SunNum;
                    break;
            }
            return weekString;
        }
        ...
        {
            string[] weekdayStrings = new string[] { Date.Monday,
            Date.Tuesday, Date.Webnesday,
           Date.Thursday, Date.Friday,
            Date.Saturday, Date.Sunday };
            return GetWeekdayStr(weekday, weekdayStrings);
        }
        public static string GetWeekdayStringShortFormat(int weekday)
        {
            string[] weekdayStrings = new string[] { Date.Mon,
            Date.Tue, Date.Web,
           Date.Thu, Date.Fri,
            Date.Sat, Date.Sun };
            return GetWeekdayStr(weekday, weekdayStrings);
        ...
        public static System.Collections.Generic.List<int> GetWeekdayList(int weekday)
        {
            System.Collections.Generic.List<int> ret = new System.Collections.Generic.List<int>();
            for (int i = 0; i < 7; i++)
            {
                if ((weekday & ((int)Math.Pow(2, i))) > 0)
                {
                    ret.Add((i + 1));
                }
            }
        ...
        private static string GetWeekdayStr(int weekday, string[] weekdayStrings)
        {
            string ret = "";
            int start = -1, i;
            for (i = 0; i < 7; i++)
        ...
        public static int EncodeWeekdayString(string sWeekday)
        {
        ...
        public static bool IsIncludeDayOfWeek(DayOfWeek dow, DateTime from, DateTime to)
        {
            int totalDays = from.Subtract(to).Days;
            if (totalDays >= 7) return true;
            for (DateTime d = from; d <= to; d = d.AddDays(1))
            {
                if (d.DayOfWeek == dow) return true;
            }
            return false;
        }

        public static int DayOfWeekToValue(DayOfWeek dayOfWeek)
        {
            int dayOfWeekValue = (int)dayOfWeek;
            dayOfWeekValue--;
            if (dayOfWeekValue < 0) dayOfWeekValue = dayOfWeekValue + 7;
            return (int)System.Math.Pow(2, (double)dayOfWeekValue);
        }
