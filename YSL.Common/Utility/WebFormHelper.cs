...
namespace YSL.Common.Utility
{
    ...
    {
        //http://www.xuebuyuan.com/1524734.html
        #region fields
        ...
        public WebFormHelper(string url, HttpClientContext context)
        ...
        public WebFormHelper(string url, HttpClientContext context, bool keepContext)
        {
            this.url = url;
